...
import Sidebar from '../Sidebar/Sidebar'; // Assuming Sidebar is in ../Sidebar/Sidebar
import './Home.css';

const Home = () => {
    const navigate = useNavigate();
    const [sections, setSections] = useState([
        { id: 1, name: "Hero Section", preview: "Transforming Ideas into Powerful Digital Products", position: 1, status: true },
        { id: 2, name: "Our Service summary", preview: "Innovating For Your Success", position: 2, status: true },
        { id: 3, name: "Features", preview: "Why Choose Us", position: 3, status: true },
        { id: 4, name: "footer", preview: "Contact Us", position: 4, status: true },
    ]);
            ...
            <div className="main-content">
                ...
                <div className="content-table-container">
                                ...
                                <tr key={section.id}>
                                    ...
                                    <td>
                                        <div className="actions">
                                            <button className="icon-btn edit" onClick={() => navigate('/admin/content-management/add')}><FaEdit /></button>
                    ...
                    <div className="add-btn-container">
                        <button className="add-new-btn" onClick={() => navigate('/admin/content-management/add')}>+ Add New</button>
                    </div>
                </div>
            </div>
        </div>
